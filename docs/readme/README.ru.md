...
<p align="center">
  ...
  Больше места для главного. Соберите файлы в стеклянные панели, переключайте проекты вкладками и вызывайте рабочий стол сочетанием клавиш. Бесплатно, с открытым кодом, для Windows 11.
</p>
