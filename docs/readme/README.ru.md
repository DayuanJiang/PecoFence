<p align="center">
  <img src="../assets/hero-ru.png" alt="PecoFence — Спокойный рабочий стол. Всё под рукой. Три настоящие области со стеклянным фоном на рабочем столе." width="1280">
</p>
...
<p align="center">
  ...
  Разложите файлы по стеклянным панелям и вызывайте их поверх любого приложения одним сочетанием клавиш.
</p>
...
**Windows 11 x64 · Портативный ZIP · Без учётной записи · Лицензия MIT**
...
- Текущие портативные сборки не подписаны.
...
PecoFence распространяется под лицензией MIT, и мы рады любому вкладу — от более точного
...
[Лицензия MIT](../../LICENSE) · [Сторонние компоненты](../../third_party/README.md)
